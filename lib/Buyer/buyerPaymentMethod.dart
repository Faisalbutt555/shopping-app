...
class BuyerPaymentMethod extends StatefulWidget {
  @override
  _BuyerPaymentMethodState createState() => _BuyerPaymentMethodState();
}

class _BuyerPaymentMethodState extends State<BuyerPaymentMethod> {
  String _group;
  bool _add = false;
